...
@default.create_hist
def default_create_hist(self: HistProducer, variables: list[od.Variable], task: law.Task, **kwargs) -> dict:
    """
...
@default.fill_hist
def default_fill_hist(self: HistProducer, h: dict, data: dict[str, Any], task: law.Task) -> None:
    """

...
"22_emu")
        ...
        bkgs="$bkg_dy$bkg_wj$bkg_vv$bkg_vvv$bkg_vh_htt$bkg_higgs$bkg_top$bkg_ttbar$signal"
        datasets="$data_egamma_2022preEE$data_mu_2022preEE${bkgs}"
        categories='cat_emu__bdt_ggh_M100,cat_emu_sr__bdt_bbh_M100'
        processes="data,dy_lep,dy_tt_m50,h_ggf_htt_sm_prod_sm,st,tt,h_vbf_htt_sm,vh_htt,wj,vv,vvv,$signal,"
        variables="N_b_jets"
        workflow='htcondor'
     ;;
...
"23_emu")
        ...
        categories='cat_emu_sr' #,cat_emu_sr__nj0,cat_emu_sr__nj1'
        processes="data,dy_lep,dy_tt_m50,h_ggf_htt_sm_prod_sm,st,tt,h_vbf_htt_sm,vh_htt,wj,vv,vvv,$signal,"
        variables="bdt_raw_score_ggh_M100,bdt_raw_score_bbh_M100,bdt_raw_score_dy_M100,bdt_raw_score_tt_M100" #$variables_emu
        workflow='local'
     ;;
"23_emu_shift")
        config="run3_2023_preBPix_emu"
...
"22preEE_lim")
        ...
        datasets="$data_egamma_2022preEE$data_mu_2022preEE${bkgs}:"
        categories='cat_emu_sr'
        processes="data,dy_lep,dy_tt_m50,h_ggf_htt,st,tt,h_vbf_htt,vh_htt,wj,vv,vvv,$signal,"
        variables=$variables_emu
        workflow='local'
     ;;
"22and23_emu_sig")
...
#########################        
    ...
    "run3_2022preEE_emu_DC")
      config="run3_2022_preEE_emu"
      processes='data,dy_lep,dy_tt_m50,h_ggf_htt,st,tt,h_vbf_htt,vh_htt,wj,vv,vvv,bbh_htt_100,h_ggf_htt_100,'
...
################################  
    "run3_2022postEE_emu_lim")
        ...
        datasets='data_egamma_E,TTto2L2Nu'
	     categories='cat_emu_sr__bdt_ggh_M100' #__nj0,cat_emu_sr__nj1'
	     variables="bdt_raw_score_ggh_M100"
	     workflow='local'
    ;;
